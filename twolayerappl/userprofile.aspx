<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="userprofile.aspx.cs" Inherits="twolayerappl.userprofile" %>
    ...
    <form id="form1" runat="server">
        <table class="auto-style1">
            ...
            <tr>
                ...
                <td class="auto-style3">
                    <asp:Image ID="Image1" runat="server" Height="87px" Width="132px" />
                </td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                            ...
                            <table class="auto-style1">
                                ...
                                <tr>
                                    ...
                                    <td class="auto-style10">
                                        <asp:Image ID="Image2" runat="server" Height="114px" ImageUrl='<%# Eval("photo") %>' />
                                    </td>
